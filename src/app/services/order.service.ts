...
makeOrderRest(obj):Observable<object>{
  this.httpOptions = {
   ...
   return this.http.post("http://40.119.240.110:4500/orders/all",obj,this.httpOptions)
} 

getOrdersByUsername():Observable<object>{
  let user=sessionStorage.getItem("username");
  return this.http.get("http://40.119.240.110:4500/orders/all/"+user);
}

getOrders():Observable<object>{

  return this.http.get("http://40.119.240.110:4500/orders/all/");
}
}
